...
const GROUPS = [
  ...
  ['مدیر — مالی', 'شهریه، صدور گروهی، پرداخت دستی و معوقات. ماژول M5.'],
  ['مدیر — پرونده', 'پرونده کودک. آلرژی اول از همه می‌آید.'],
  ['والد — بیشتر', 'اعلام غیبت، پیام به مربی، اطلاعیه‌ها، و مالی.'],

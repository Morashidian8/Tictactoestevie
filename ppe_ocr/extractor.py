...
_PERSON = {
    ...
    "properties": {
        ...
        "job_title": {"type": ["string", "null"], "description": "عنوان شغل/سمت اگر جلوی اسم نوشته شده (مثل امداد، تعمیرات، تکنسین)"},
        "size": {"type": ["string", "null"], "description": "سایز البسه اگر برای همین نفر مشخص شده"},
        "company": {"type": ["string", "null"], "description": "نام شرکتِ پیمانکار اگر این نفر پیمانکار است و روی حواله نوشته شده"},
        "contract_number": {"type": ["string", "null"], "description": "شماره پیمانِ پیمانکار اگر نوشته شده"},
    },
    "required": ["first_name", "last_name", "code", "job_title", "size", "company", "contract_number"],
}
...
- اگر فردی پیمانکار است (کد ملیِ ۱۰ رقمی) و نام شرکتِ پیمانکار یا شماره پیمانِ او روی حواله نوشته شده، آن‌ها را در company و contract_number همان نفر بگذار.

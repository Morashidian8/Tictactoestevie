...
- فهرست افراد: در قسمت DESCRIPTION دست‌نویس، هر نفر یک شماره ردیف، نام و نام خانوادگی و یک کد دارد.
  کد ۵ تا ۷ رقمی = کد پرسنلی؛ کد ۱۰ رقمی = کد ملی. اگر جلوی اسم شغل نوشته شده (امداد/تعمیرات/تکنسین) آن را در job_title بگذار.
...
- تاریخ تحویل دست‌نویس معمولاً کنار امضای تحویل‌گیرنده است؛ فقط ماه و سال کافی است.
